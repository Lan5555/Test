...
let nextPage4 = document.getElementById("quizContainer");
  ...
  var currentQuestionIndex = 0;
   ...
   {question:"Evaluate the expression: 4² - 2(3 + 5)", options:["-6", "2", "10", "18"], correctAnswerIndex:2},
   {question:"What is the solution to the inequality: 2x + 7 < 15", options:["x < 4", "x > 4", "x < 5", "x > 5"], correctAnswerIndex:2},
